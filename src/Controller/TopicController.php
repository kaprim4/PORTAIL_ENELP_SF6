...
class TopicController extends MasterController
{
    public function __construct(ManagerRegistry $registry)
    {
        ...
        $this->setObjectRepository(new TopicRepository($registry));
    ...
    #[Route('/{id}/enable', name: 'app_topic_enable', methods: ['GET', 'POST'])]
    public function enable(Request $request): Response
    {
        return parent::enable($request); // TODO: Change the autogenerated stub
    }

    #[Route('/{id}/disable', name: 'app_topic_disable', methods: ['GET', 'POST'])]
