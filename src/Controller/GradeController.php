...
class GradeController extends MasterController
{
    public function __construct(ManagerRegistry $registry)
    {
        ...
        $this->setObjectRepository(new GradeRepository($registry));
    ...
    #[Route('/{id}/enable', name: 'app_grade_enable', methods: ['GET', 'POST'])]
    public function enable(Request $request): Response
    {
        return parent::enable($request); // TODO: Change the autogenerated stub
    }

    #[Route('/{id}/disable', name: 'app_grade_disable', methods: ['GET', 'POST'])]
