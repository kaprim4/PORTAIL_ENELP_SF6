import ApexCharts from '../../libs/apexcharts/apexcharts.min';
import Swiper from '../../libs/swiper/swiper-bundle.min';
...
let worldemapmarkers, vectorMapWorldMarkersColors = getChartColorsArray("sales-by-locations");
...
let overlay, swiper = new Swiper(".vertical-swiper", {
    slidesPerView: 2,
    spaceBetween: 10,
    mousewheel: !0,
    loop: !0,
...
layoutRightSideBtn && (Array.from(document.querySelectorAll(".layout-rightside-btn")).forEach(function (e) {
    const r = document.querySelector(".layout-rightside-col");
